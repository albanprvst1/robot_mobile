    ...
    def dessiner(self, env):
        ...
        if env.robot:
            ...
            for i in range(nb_rayons + 1):
                ...
                p_fin = self.convertir_coordonnees(
                    env.robot.x + d * math.cos(angle),
            ...
            for i in range(-5, 6):
                ...
                p_lidar = self.convertir_coordonnees(
                    env.robot.x + d_lidar * math.cos(a_lidar),
        ...
        if env.alerte and not env.game_over:
        ...
        if env.game_over:
            ...
            if env.game_over_raison == "WIN":
                msg = msg_font.render("WIN", True, (0, 255, 0))
            else:
